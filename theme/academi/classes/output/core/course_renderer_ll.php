...
class course_renderer extends \core_course_renderer {
    ...
    public function frontpage_available_courses() {
		...
		return "Frontpage available courses";
    }
	public function frontpage_my_courses() {
        ...
        $courses = enrol_get_my_courses('summary, summaryformat');// core_course_category::get(0)->get_courses( $chelper->get_courses_display_options() );

        $totalcount = count($courses);//core_course_category::get(0)->get_courses_count( $chelper->get_courses_display_options() );
	...
	public function frontpage_enrolled_courses() {
